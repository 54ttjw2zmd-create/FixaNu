export default function Page() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#F4FBF7] via-[#FFFFFF] to-[#EEF8F1] text-[#0B2341] flex flex-col items-center justify-center px-6 py-16 overflow-hidden relative">
